  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-50">
        ...
        <header className="flex items-center justify-between px-4 lg:px-6 py-4 border-b border-slate-200 bg-white shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-semibold text-slate-800">{activeNav.label}</h2>
            </div>
          </div>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-30 lg:hidden w-14 h-14 bg-blue-600 hover:bg-blue-500 text-white rounded-2xl shadow-lg flex items-center justify-center transition"
      >
