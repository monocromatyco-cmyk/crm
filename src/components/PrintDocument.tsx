...
export default function PrintDocument({
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/50 flex items-start justify-center overflow-y-auto p-4">
      ...
      {/* Document */}
      <div className="print-container bg-white rounded-xl shadow-2xl w-full max-w-3xl my-8 p-8">
        {/* Header */}
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              {settings.bankClabe && (
                <>
                  ...
                  <span className="text-slate-700 font-mono">{settings.bankClabe}</span>
                </>
              )}
        ...
        <div className="mt-8 pt-4 border-t border-slate-200 text-center">
          <p className="text-xs text-slate-400">
            Documento generado por {settings.businessName} • {today}
          </p>
        </div>
      </div>
    </div>
