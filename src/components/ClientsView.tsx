        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {filtered.map((c) => (
            <div
              key={c.id}
              onClick={() => openEdit(c)}
              className="card-base p-4 hover:border-blue-300 transition-all duration-200 cursor-pointer group"
            >
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-50 to-violet-50 flex items-center justify-center shrink-0">
        ...
        <div className="fixed inset-0 z-50 bg-black/30 backdrop-blur-sm flex items-start justify-center overflow-y-auto p-4">
          <div className="card-base w-full max-w-lg my-8 p-6 space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-bold text-gray-900">{isNew ? 'Nuevo cliente' : 'Editar cliente'}</h2>
            ...
            <div>
              <label className="text-xs text-gray-500 font-medium mb-1 block">Empresa</label>
              <div className="relative">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-xs text-gray-500 font-medium mb-1 block">Representante</label>
                <input value={editing.representativeName} onChange={(e) => setEditing({ ...editing, representativeName: e.target.value })} className="input-field" />
              </div>
              <div>
                <label className="text-xs text-gray-500 font-medium mb-1 block">Cargo</label>
                <div className="relative">
                  <Briefcase className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                  <input value={editing.role} onChange={(e) => setEditing({ ...editing, role: e.target.value })} className="input-field pl-10" />
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <div className="relative">
                  ...
                  <input value={editing.phone} onChange={(e) => setEditing({ ...editing, phone: e.target.value })} className="input-field pl-10" />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  ...
                  <input value={editing.email} onChange={(e) => setEditing({ ...editing, email: e.target.value })} className="input-field pl-10" type="email" />
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input value={editing.address} onChange={(e) => setEditing({ ...editing, address: e.target.value })} className="input-field pl-10" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea value={editing.notes} onChange={(e) => setEditing({ ...editing, notes: e.target.value })} className="input-field pl-10 min-h-[80px] resize-none" />
              </div>
            </div>
